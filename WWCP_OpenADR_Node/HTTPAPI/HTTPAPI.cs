...
namespace cloud.charging.open.protocols.OpenADRv3.Node
{
    ...
    /// <summary>
    /// The OpenADR Networking Node HTTP API.
    /// </summary>
                           ...
                           IHTTPAPIExtension<HTTPExtAPI>
    {
        ...
        /// </summary>
        public const    String                     DefaultHTTPServerName     = $"Open Charging Cloud OpenADR Networking Node HTTP API";

        /// <summary>
        /// The default HTTP realm, if HTTP Basic Authentication is used.
        /// </summary>
        public const String                        DefaultHTTPRealm          = "Open Charging Cloud OpenADR Networking Node HTTP API";

        /// <summary>
        /// The HTTP root for embedded ressources.
        /// </summary>
        public const String                        HTTPRoot                  = "cloud.charging.open.protocols.OpenADR.NetworkingNode.HTTPAPI.HTTPRoot.";


        //ToDo: http://www.iana.org/form/media-types

        /// <summary>
        /// The HTTP content type for serving OpenADR+ XML data.
        /// </summary>
        public static readonly HTTPContentType     OpenADRPlusJSONContentType   = new ("application", "vnd.OpenADRPlus+json", "utf-8", null, null);

        /// <summary>
        /// The HTTP content type for serving OpenADR+ HTML data.
        /// </summary>
        public static readonly HTTPContentType     OpenADRPlusHTMLContentType   = new ("application", "vnd.OpenADRPlus+html", "utf-8", null, null);

        /// <summary>
        /// The unique identification of the OpenADR HTTP SSE event log.
        /// </summary>
        public static readonly HTTPEventSource_Id  EventLogId                = HTTPEventSource_Id.Parse("OpenADREvents");


        protected readonly AOpenADRNode networkingNode;
        ...
        /// <summary>
        /// Attach the given OpenADR charging station management system WebAPI to the given HTTP API.
        /// </summary>
        /// <param name="NetworkingNode">An OpenADR charging station management system.</param>
        /// <param name="HTTPAPI">A HTTP API.</param>
        /// <param name="URLPathPrefix">An optional prefix for the HTTP URLs.</param>
        /// <param name="HTTPRealm">The HTTP realm, if HTTP Basic Authentication is used.</param>
        /// <param name="HTTPLogins">An enumeration of logins for an optional HTTP Basic Authentication.</param>
        public HTTPAPI(AOpenADRNode                                NetworkingNode,
                       HTTPExtAPI                                  HTTPAPI,
        ...
        private void RegisterURITemplates()
        {
            ...
            //                                HTTPHostname.Any,
            //                                URLPathPrefix,
            //                                "cloud.charging.open.protocols.OpenADR.WebAPI.HTTPRoot",
